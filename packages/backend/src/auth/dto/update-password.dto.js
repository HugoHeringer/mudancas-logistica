...
let UpdatePasswordDto = (() => {
    ...
    return class UpdatePasswordDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _userId_decorators = [ApiProperty(), IsString(), IsNotEmpty()];
            _currentPassword_decorators = [ApiProperty(), IsString(), MinLength(6), IsNotEmpty()];
            _newPassword_decorators = [ApiProperty(), IsString(), MinLength(6), IsNotEmpty()];
        ...
        currentPassword = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _currentPassword_initializers, void 0));
