...
let LoginDto = (() => {
    ...
    return class LoginDto {
        static {
            ...
            _email_decorators = [ApiProperty({ example: 'admin@empresa.pt' }), IsEmail(), IsNotEmpty()];
        ...
        tenantId = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _tenantId_initializers, void 0));
        constructor() {
