...
let VeiculoService = (() => {
    ...
    let _classThis;
    var VeiculoService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            VeiculoService = _classThis = _classDescriptor.value;
        ...
        async create(tenantId, createVeiculoDto) {
        ...
        async getDisponiveis(tenantId, paraUrgencias) {
            const where = {
                tenantId,
                estado: 'disponivel',
            };
        ...
        async update(tenantId, id, updateVeiculoDto) {
    ...
    return VeiculoService = _classThis;
})();
