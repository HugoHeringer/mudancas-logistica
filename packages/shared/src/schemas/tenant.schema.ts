...
export type EstadoTenant = z.infer<typeof EstadoTenantEnum>;
export type ConfigMarca = z.infer<typeof ConfigMarcaSchema>;
export type ConfigPreco = z.infer<typeof ConfigPrecosSchema>;
